...
from core.views import home, cadastro_cliente, listagem_clientes, cadastro_veiculo, listagem_veiculos, Registrar, atualizar_cliente, exclui_cliente, exclui_veiculo, atualiza_veiculo, cadastro_fabricante, listagem_fabricantes, exclui_fabricante, cadastro_tabela, exclui_tabela, listagem_tabelas, listagem_rotativos, cadastro_rotativo, listagem_mensalistas, cadastro_mensalista, atualiza_rotativos, atualiza_mensalistas, exclui_rotativo, exclui_mensalista, atualizar_fabricante
...
urlpatterns = [
    ...
    path('atualiza_fabricante/<int:id>/', atualizar_fabricante, name='url_atualiza_fabricante'),
    ...
    path('atualiza_rotativo/<int:id>', atualiza_rotativos, name='url_atualiza_rotativo'),
    ...
    path('atualiza_mensalista/<int:id>/', atualiza_mensalistas, name='url_atualiza_meensalista'),
    path('exclui_mensalista/<int:id>/', exclui_mensalista, name='url_exclui,mensalista'),
]
