...
def listagem_clientes(request):
    if request.POST and request.POST['input_pesquisa']:
        dados = Cliente.objects.filter(nome__contains=request.POST['input_pesquisa'])##.filter(nome__iexact=request.POST['input_pesquisa'])
    else:
...
def atualizar_cliente(request, id):
    ...
    if form.is_valid():
        ...
        return redirect('url_listagem_clientes')
    contexto = {'form': form, 'txt_tittle': 'Atualização de Cliente', 'txt_descricao': 'Atualização de Cliente',
...
def atualiza_veiculo(request, id):
    ...
    if form.is_valid():
        form.save()
        return redirect('url_listagem_veiculos')
    contexto = {'form': form, 'txt_tittle': 'Atualização de Veiculo', 'txt_descricao': 'Atualização de Veiculo',
                'txt_button': 'Atualizar'}
    return render(request, 'core/cadastro.html', contexto)
...
def atualizar_fabricante(request, id):
    ...
    if form.is_valid():
        form.save()
        return redirect('url_listagem_fabricantes')
    contexto = {'form': form, 'txt_tittle': 'Atualização de Fabricante', 'txt_descricao': 'Atualização de Fabricante',
                'txt_button': 'Atualizar'}
...
def atualiza_rotativos(request, id):
    ...
    if form.is_valid():
        ...
        contexto = {'form': form, 'txt_tittle': 'Atualização de Rotativo', 'txt_descricao': 'Atualização de Rotativo',
                    'txt_button': 'Atualizar'}
        return render(request, 'core/cadastro.html', contexto)
...
def atualiza_mensalistas(request, id):
    ...
    if form.is_valid():
        ...
        contexto = {'form': form, 'txt_tittle': 'Atualização de Mensalista', 'txt_descricao': 'Atualização de Mensalista',
                    'txt_button': 'Atualizar'}
        return render(request, 'core/cadastro.html', contexto)
